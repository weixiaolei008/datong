<template>
  <el-container  style="width: 100%;height: 100%;">
    ...
    <!--附件详情-->
    <el-dialog title="附件详情" :visible.sync="popAddVisible1" width="680px" align="center">
...
<script>
  ...
  import {loadBatchList,loadBatchExport,loadBatchOutNCreat,loadBatchDelete} from "@/common/config/api/PlanManage"
      ...
      handelExport(){
        ...
        if(self.selectRows.length){
          ...
          p = {
            ...
            applicationStartDate: self.formData.applicationDate !== null ? self.formData.applicationDate[0] : '', //申请开始时间
            applicationEndDate: self.formData.applicationDate !== null ? self.formData.applicationDate[1] : '', //申请结束时间
          }
        }
