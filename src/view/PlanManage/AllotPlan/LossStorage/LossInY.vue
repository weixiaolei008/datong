...
<script>
  ...
  import {loadLossList,loadLossExport} from "@/common/config/api/PlanManage"
  import {loadDicValList} from "@/common/config/api/basic"
  import {getSplitString,exportFile,w200, w180, w120}from "@/common/config/utils"
    ...
    methods: {
      ...
      handelExport(){
        ...
        if(self.selectRows.length){
          ...
          p = {
            listType: 12, //列表类型 11出库 12入库 37库内 66出库预计划 67入库预计划 68库内质损预计划,
