...
<script>
  import {loadCarMoveY, exportCarMoveY} from "@/common/config/api/PlanManage"
        ...
        tableData: {
          ...
          tableHead: [
            ...
            },
            {
              name: "目标库区",
              width: w120,
              value: 'goalRegionName',
            },
            {
              name: "目标库位",
              width: w150,
              value: 'goalLocationId',
            },
            {
              name: "指令来源",
              value: 'orderSource',
    ...
    methods: {
      loadData() {
        ...
        let p = {
          ...
          "goalRegionId":self.data.formData.goalRegionId,
          "pageNum": self.tableData.currentPage,
          "pageSize": self.tableData.pageSize,
        }
        loadCarMoveY(p).then(res => {
          if(res && res.repData){
