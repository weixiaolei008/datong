...
<script>
  import {loadCarMaintenanceN, exportCarMaintenanceN, importHuN, creatCarWash, delCarWash} from "@/common/config/api/PlanManage"
  ...
  export default {
    ...
    methods: {
      ...
      loadData() {
        ...
        loadCarMaintenanceN(p).then(res => {
          if(res && res.repData){
      ...
      handleExport(){
        ...
        exportCarMaintenanceN(p).then(res => {
