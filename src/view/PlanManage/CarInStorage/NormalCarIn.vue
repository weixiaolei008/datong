...
<script>
  import {loadCarInStorage, exportCarInStorage} from "@/common/config/api/PlanManage"
      ...
      handleExport(){
        ...
        if(this.selectRows.length){
          ...
          p = {
            "planType": 43, // 区分接口
            "vins": getSplitString(self.data.formData.vin),
            "startInboundDate": self.data.formData.ableInboundDate !== null ? self.data.formData.ableInboundDate[0] : '',
            "endInboundDate": self.data.formData.ableInboundDate !== null ? self.data.formData.ableInboundDate[1] : '',
            "category": self.data.formData.category,
            "color": self.data.formData.color,
            "driveMode": self.data.formData.driveMode,
            "goalWarehouse": self.data.formData.goalWarehouse,
