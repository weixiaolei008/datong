...
<script>
  ...
  import {loadTwicePlanList,loadTwicePlanExportWindow,loadTwicePlanReceiveCar} from "@/common/config/api/SysWindows"
...
//-------------------------table-------------------
      ...
      handelExport(val){
        ...
        loadTwicePlanExportWindow(p).then(res => {
      ...
      handleConfirmCarData(){
        ...
        loadTwicePlanReceiveCar(p).then(res =>{
