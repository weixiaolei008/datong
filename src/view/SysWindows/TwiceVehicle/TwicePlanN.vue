...
<script>
  ...
  import {loadTwicePlanList,loadTwicePlanExportWindow,loadTwicePlanDeliveryCar} from "@/common/config/api/SysWindows"
...
//-------------------------table-------------------
      ...
      handelExport(val){
        ...
        if(self.selectRows.length){
          ...
          p = {
            ...
            origWarehouseName: self.formData.origWarehouseName, //  始发仓库 ,
      ...
      handleNoticeCarData(){
        ...
        loadTwicePlanDeliveryCar(p).then(res =>{
