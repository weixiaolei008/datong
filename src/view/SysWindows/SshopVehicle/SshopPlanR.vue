  ...
  <el-container  style="width: 100%;height: 100%;">
    <el-header style="height: auto; padding: 0;">
      ...
      <div class="btn-group clearfix">
        <div class="btn-receive" @click="handleConfirmCar"><span class="img-receive">确认收车</span></div>
...
<script>
  ...
  import {loadSshopPlanList,loadSshopPlanReceiveCar,loadSshopPlanExport} from "@/common/config/api/SysWindows"
  import {loadDicValList} from "@/common/config/api/basic"
  import {getSplitString,confirmPop,w200,w120}from "@/common/config/utils"
...
//-------------------------table-------------------
      ...
      handleConfirmCarData(){
        ...
        loadSshopPlanReceiveCar(p).then(res =>{
