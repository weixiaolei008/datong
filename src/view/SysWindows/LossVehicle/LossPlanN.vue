  ...
  <el-container  style="width: 100%;height: 100%;">
    <el-header style="height: auto; padding: 0;">
      ...
      <div class="btn-group clearfix">
        <div @click="handleNoticeCar" class="btn-inform"><span class="img-inform">通知提车</span></div>
...
<script>
  ...
  import {loadLossPlanList,loadLossPlanExportWindow,loadLossPlanDeliveryCar} from "@/common/config/api/SysWindows"
...
//-------------------------table-------------------
      ...
      handleNoticeCar(){
        ...
        //   return
        // }
        confirmPop('请确认收车',this.handleNoticeCarData)
      },
      /*/////////////////////////////////////////////////////////////////////////*/
      //导出接口
      handelExport(){
        ...
        if(self.selectRows.length){
          ...
          p = {
            ...
            commondEndDate: self.formData.backCommandDate !== null ? self.formData.backCommandDate[1] : '', //指令下达结束时间
      ...
      handleNoticeCarData(){
        ...
        loadLossPlanDeliveryCar(p).then(res =>{
